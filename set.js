...
global.caption = "*drchanda*"; // Input Yours custom...(Maintain font for Flow)
...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "Gifted~RG8DFJqQ#012K8BZ59WqBRdiAdtwLKabm2d_5vCvOFh6_x5wHaIE", // Add sess Id here espwcially when deploying on panels else use app.json and .env file...
SUDO_NUMBERS: process.env.SUDO_NUMBERS || "27781673022", //Add multiple Numbers with Country Codes without (+) Separated by Comma...
...
OWNER_NUMBER: process.env.OWNER_NUMBER || "27781673022", // Only 1 owner Number Here, others Add to sudo numbers...
OWNER_NAME: process.env.OWNER_NAME || "chanda", // Input Yours custom...(Maintain font for Flow)
PACK_AUTHOR: process.env.PACK_AUTHOR || "chanda", // Added // Input Yours custom...
PACK_NAME: process.env.PACK_NAME || "chanda💜", // Added // Input Yours custom...
...
BOT_NAME: process.env.BOT_NAME || "chanda", // Input Yours custom...(Maintain font for Flow)
